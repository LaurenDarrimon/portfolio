...
export const projectData = [
    {
      ...
      image_path: "https://laurendarrimon.github.io/portfolio/assets/images/rubber-duck.png",
      backend:false
    },
    {
      id: 2,
      ...
      image_path: "https://laurendarrimon.github.io/portfolio/assets/images/map-test.png",
      backend:false
    },
    {
      id: 3,
      ...
      image_path: "https://laurendarrimon.github.io/portfolio/assets/images/neighborgood.png",
      backend:false
    ...
    },
    {
      ...
      description: "API for a social network web application where users can share their thoughts, react to friends’ thoughts, and create a friend list. Uses Express.js for routing, a MongoDB database, and Mongoose ODM.",
      details:"",
      ...
      image_path: "https://laurendarrimon.github.io/portfolio/assets/images/social-api.png",
      backend:true
    ...
    },
    {
      id: 5,
      title: "Text Editor",
      description: "Full-stack progressive web application (PWA) with data persistence techniques and offline capabilities for using an IndexedDB database with an idb wrapper.",
      details:"",
      repo_url: "https://github.com/LaurenDarrimon/text-editor",
      deployed_url: "https://polar-temple-63530.herokuapp.com/",
      image_path: "https://laurendarrimon.github.io/portfolio/assets/images/text-editor.png",
      backend:false
    ...
    },
    {
      ...
      description: "Back end for an e-commerce site using Express.js API and Sequelize to interact with a MySQL product database.",
      details:"",
      ...
      image_path: "https://laurendarrimon.github.io/portfolio/assets/images/e-commerce.png",
      backend:true
